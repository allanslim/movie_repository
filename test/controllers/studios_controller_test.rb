...
class StudiosControllerTest < ActionController::TestCase
  ...
  test "should create studio" do
    assert_difference('Studio.count') do
      post :create, studio: { address: @studio.address, fax: @studio.fax, name: @studio.name, telephone: @studio.telephone }
    end
  ...
  test "should update studio" do
    patch :update, id: @studio, studio: { address: @studio.address, fax: @studio.fax, name: @studio.name, telephone: @studio.telephone }
    assert_redirected_to studio_path(assigns(:studio))
  end
