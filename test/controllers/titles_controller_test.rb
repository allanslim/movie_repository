...
class TitlesControllerTest < ActionController::TestCase
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post :create, title: { description: @title.description, length: @title.length, name: @title.name, rating: @title.rating }
    end
  ...
  test "should update title" do
    patch :update, id: @title, title: { description: @title.description, length: @title.length, name: @title.name, rating: @title.rating }
    assert_redirected_to title_path(assigns(:title))
  end
